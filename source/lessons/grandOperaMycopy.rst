...
COMMENT: When defining grand opera, we must keep in mind that it has at times
been used extremely liberally. In addition to the Parisian opera that we'll be discussing today, it 
has (incorrectly) been used to describe the works of Verdi, Wagner, Gounod, and Bizet among others. 
...
COMMENT: Perhaps one of the more colorful 
examples comes from Carolyn Abbate and Roger Parker's recent
book on Opera. They write...
...
.. figure:: figures/giacomo_meyerbeer_jakob_portrait_3.jpg
		   :scale: 40 %
...
.. figure:: figures/operaCount.png
		   :scale: 120 %
	
COMMENT: It's hard to underestimate Meyerbeer's influence on the operatic scene in Paris in the mid-19th
century.
...
COMMENT: Play in Spotify. No score or video.
...
COMMENT: Note the chorus, and the fact that the scale has grown significantly since Rossini and Weber.
...
COMMENT: And we should actually talk a bit more about Scribe.  He was seen by many as the cornerstone of
Grand Opera.

.. figure:: figures/scribe.png
		   :scale: 120 %
...
COMMENT: It's probably worth discussing the role of these love triangles and "star-crossed lovers" situations. Scott
Balthazar has a nice taxonomy of these.
